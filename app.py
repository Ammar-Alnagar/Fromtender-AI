                ...
                try:
                    ...
                    for chunk in completion:
                        if chunk.choices[0].delta.content:
                            ...
                            yield {
                                code_output: accumulated_content,
                                state_tab: gr.update(active_key="loading"),
                                code_drawer: gr.update(open=True),
                            }

                    # After streaming is complete
                    _history.append([query, accumulated_content])
                    yield {
                        code_output: accumulated_content,
                        history: _history,
                        sandbox: send_to_sandbox(remove_code_block(accumulated_content)),
                    ...
                    yield {
                        code_output: f"An error occurred: {str(e)}",
